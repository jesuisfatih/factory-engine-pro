    ...
    messages: [
      {
        ...
        content: {
          ...
          text: [
            ...
            'If the user asks to change the staff sidebar, nav item names, nav order, groups, badges, or default route, do not force it into staff.queue overlays. Current runtime tools cannot apply navigation changes yet; use a maintainer source patch today or a future typed navigationOverrides contract with known nav ids and screenshot proof.',
