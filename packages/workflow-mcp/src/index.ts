    ...
    messages: [
      {
        ...
        content: {
          ...
          text: [
            ...
            'Use the staff.queue element map from get_frontend_surface_contract: current MVP supports overlay slots; future element-level changes must be typed elementOverrides, not raw CSS.',
