    ...
    messages: [
      {
        ...
        content: {
          ...
          text: [
            ...
            '1. list_workflow_capabilities and inspect the registry.operationalIntents, registry.conditions, and registry.actions entries.',
            ...
            '6. simulate_workflow_rule again using the stored ruleId; this stored simulation report is required for publish.',
            '7. publish_workflow_rule only when the user explicitly approves and supplies the stored simulation report id.',
            '',
