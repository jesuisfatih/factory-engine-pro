...
const FRONTEND_MCP_SURFACES: FrontendMcpSurfaceContract[] = [
  {
    ...
    elementMap: [
      ...
      },
      {
        ...
        currentSupport: 'Typed runtime field and copy overrides are wired for the centered popup; customer name and phone remain required.',
        nextSafeSupport: 'Use the source patch lane only for new native popup sections beyond the field/copy contract.',
      },
      {
