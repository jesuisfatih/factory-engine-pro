...
import { AircallRollingSyncWorker } from './aircall-rolling-sync.worker.js';
...
@Module({
  ...
  providers: [AircallRepository, AircallService, AircallIngestService, AircallIngestWorker, AircallRollingSyncWorker],
