...
function vendorChunk(id: string) {
  ...
  if (normalized.includes('/@dnd-kit/') || normalized.includes('/@xyflow/')) return 'vendor-interactions';
  if (normalized.includes('/socket.io-client/') || normalized.includes('/engine.io-client/')) return 'vendor-realtime';
  return undefined;
}
